  ...
  return (
    <header className="py-6 relative z-50">
      <div className="flex items-center justify-between">
        <Link
          href="/"
          className={`font-bold text-3xl transition-all text-opacity-100 opacity-100 duration-300 hover:underline-offset-4 hover:underline decoration-2 decoration-black-200 ${
